    ...
    data() {
        return {
            ...
            links: [
                ...
                { title: 'Fourthwall', url: 'https://shop.morbidlyocheese.com/', icon: 'https://t1.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://fourthwall.com&size=128', description: '', label: 'fourthwall' },
